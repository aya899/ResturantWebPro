...
if(isset($_POST['booknow'])){
   ...
   if(!empty($name)&& !empty($phone)&& !empty($email)&& !empty($persons) && !empty($date)){
    $query="INSERT INTO `user_info`(`user_name`, `user_number`, `user_email`, `person_num` , `date`) 
...
<head>
  ...
  <style>
    .food_section  .container  .fa_eyes{
      position:absolute;
      top:1rem; right:1rem;
      border-radius:.5rem;
      height:4.5rem;
